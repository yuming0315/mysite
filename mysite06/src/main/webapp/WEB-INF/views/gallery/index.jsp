		...
		<div id="content">
			<div id="gallery">
				<div>
					<h1>갤러리</h1>
					<c:if
						test="${not empty authUser && 'ADMIN'.equals(authUser.role) }">
						...
						<li><a href="${pageContext.request.contextPath }${vo.url }"
							...
							<c:if
								...
								<a
									...
									class="del-button" title="삭제">
									<img style="width:15px; align:right;" src="${pageContext.request.contextPath }/assets/images/close.png" />삭제</a>
							</c:if></li>
				...
				<div id="dialog-upload-form" title="이미지 업로드" style="display: none">
					...
					<form action="${pageContext.request.contextPath }/gallery/upload"
						...
						<label>코멘트</label> <input type="text" id="comments"
